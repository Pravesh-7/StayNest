...
const MyBookings = () => {
  ...
  return (
    <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
      <Title
        title="My Bookings"
        subTitle="Easily manage your past, current, and upcoming hotel reservations in one place. Plan your trips seamlessly with just a few clicksclicks"
        align="left"
      />
          ...
          >
            ...
            <div className="flex flex-col mid:flex-row">
              ...
              <div className="flex flex-col gap-1.5 max-md:mt-3 md:ml-4">
                ...
                <div className="flex items-center gap-1 text-sm text-gray-500">
                  <img src={assets.guestIcon} alt="guest-icon" />
